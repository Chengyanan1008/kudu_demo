...
public class Test {
    ...
    public  final static String masteraddr = "localhost";
    // 创建kudu的数据库链接
    public static KuduClient client = new KuduClient.KuduClientBuilder(masteraddr).defaultSocketReadTimeoutMs(6000).build();
...
//        alterColumnTEST();
    ...
    public static void selectTest() {
        ...
        List<KuduColumn> list = new ArrayList<KuduColumn>();
        list.add(column01);
        list.add(column02);
        list.add(column03);
    ...
    public static void alterColumnTEST() throws KuduException {
        ...
        List<KuduColumn> rows01 = new ArrayList<KuduColumn>();
        rows01.add(c01);
        rows01.add(c02);
        ...
        List<KuduColumn> rows11 = new ArrayList<KuduColumn>();
        rows11.add(c11);
        rows11.add(c12);
        myrows11.setRows(rows11);

        List<KuduRow> list = new ArrayList<KuduRow>();
        list.add(myrows01);
        list.add(myrows11);
    ...
    public static void deleteMultTEST() throws KuduException {
        ...
        List<KuduColumn> row01 = new ArrayList<KuduColumn>();
        row01.add(c01);
//        row01.add(c02);
        KuduRow myrows01 = new KuduRow();
        ...
        List<KuduColumn> row11 = new ArrayList<KuduColumn>();
        row11.add(c11);
//        row11.add(c12);
        KuduRow myrows11 = new KuduRow();
        myrows11.setRows(row11);

        List<KuduRow> rows = new ArrayList<KuduRow>();
        rows.add(myrows01);
        rows.add(myrows11);
...
//        row01.add(c02);
    ...
    public static void insertMultTEST() throws KuduException {
        ...
        List<KuduColumn> row02 = new ArrayList<KuduColumn>();
        row02.add(c11);
        row02.add(c12);
        KuduRow myrows02 = new KuduRow();
